...
namespace RinhaBackend.Migrations
{
    ...
    [Migration("20230916170944_ChangeNascimentoToDateType")]
    partial class ChangeNascimentoToDateType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RinhaBackend.Models.Person", b =>
                {
                    ...
                    b.Property<string>("SearchField")
                        ...
                        .HasColumnType("text")
                        .HasComputedColumnSql("\"Apelido\" || ' ' || \"Nome\" || ' ' || array_to_string_immutable(\"Stack\", ' ')", true);
