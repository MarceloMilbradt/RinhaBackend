...
namespace RinhaBackend.Migrations
{
    ...
    [Migration("20230916165513_InitialRinhaBackendMigration")]
    partial class InitialRinhaBackendMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RinhaBackend.Models.Person", b =>
                {
                    ...
                    b.Property<string>("SearchField")
                        ...
                        .HasColumnType("text")
                        .HasComputedColumnSql("\"Apelido\" || ' ' || \"Nome\" || ' ' || ARRAY_TO_STRING(\"Stack\", ' ')", true);
